...
GfxVulkanFormatMap::GfxVulkanFormatMap() {
  ...
  map(GfxFormat::eR8G8B8un, VK_FORMAT_R8G8B8_UNORM);
  map(GfxFormat::eR8G8B8sn, VK_FORMAT_R8G8B8_SNORM);
  map(GfxFormat::eR8G8B8ui, VK_FORMAT_R8G8B8_UINT);
  map(GfxFormat::eR8G8B8si, VK_FORMAT_R8G8B8_SINT);
  ...
  map(GfxFormat::eR10G10B10A2sn, VK_FORMAT_A2B10G10R10_SNORM_PACK32);
  ...
  map(GfxFormat::eB10G10R10A2sn, VK_FORMAT_A2R10G10B10_SNORM_PACK32);
  ...
  map(GfxFormat::eR16G16B16un, VK_FORMAT_R16G16B16_UNORM);
  map(GfxFormat::eR16G16B16sn, VK_FORMAT_R16G16B16_SNORM);
  map(GfxFormat::eR16G16B16ui, VK_FORMAT_R16G16B16_UINT);
  map(GfxFormat::eR16G16B16si, VK_FORMAT_R16G16B16_SINT);
  map(GfxFormat::eR16G16B16f, VK_FORMAT_R16G16B16_SFLOAT);
